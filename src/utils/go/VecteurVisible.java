...
public class VecteurVisible {
	private PointVisible from;
	private PointVisible to;
	public String label;

	public VecteurVisible(PointVisible f, PointVisible t) {
		from = f;
		to = t;
	}
	
	public VecteurVisible(Point f, Point t) {
		from = f.toPointVisible();
		to = t.toPointVisible();
	}

	public VecteurVisible(int x, int y, int x2, int y2) {
...
//		to.dessine(g);
	...
	private VecteurVisible copy() {
		VecteurVisible v = new VecteurVisible(this.from.x, this.from.y, this.getTo().x, this.getTo().y);
		return v;
	}
